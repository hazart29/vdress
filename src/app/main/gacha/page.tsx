...
export default function Page() {
    ...
    class GachaSystem {
        ...
        calculateRarity() {
            ...
            fetchApiGacha('getPity', null)
            console.log('fetched api get pity');
            if (rand < incSSRProbability || Array.isArray(dataPOST) && dataPOST[0].pitycounter >= 90) {
                return "SSR";
    ...
    function pull(a: number) {
        ...
        console.log('fetched api update primo');
