...
const GachaButton: React.FC<GachaButtonProps> = ({ onClick }) => {
  return (
    <div className="flex flex-1 gap-4 justify-end items-center">
      <button
        className="bg-white text-4xl text-gray-800 font-bold py-2 px-4 rounded-md shadow-md hover:bg-gray-100 transition duration-200 ease-in-out flex items-center"
        onClick={() => onClick(1)} 
      >
        <span className="mr-2">1x Draw</span>
        <img src="/images/primogem.png" alt="Primogem" className="w-6 h-6" />
